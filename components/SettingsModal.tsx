    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-8">
          ...
          {/* CONFIGURAÇÃO DA INTELIGÊNCIA ARTIFICIAL (IA) */}
          <section>
            <h3 className="text-sm font-semibold text-purple-900 uppercase tracking-wide mb-4 border-b pb-2 flex items-center gap-2">
              <Key size={18} />
              Inteligência Artificial (Google Gemini)
            </h3>
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              <label className="block text-sm font-bold text-purple-800 mb-2">Sua Chave de API (API Key)</label>
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 border border-purple-300 rounded px-3 py-2 outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <p className="text-xs text-purple-700">
                * Esta chave conecta o sistema à IA do Google e é obrigatória para o funcionamento dos recursos inteligentes.
                <br />
                <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="underline font-bold hover:text-purple-900">
                  Clique aqui para gerar sua chave gratuitamente no Google AI Studio.
                </a>
              </p>
            </div>
          </section>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md font-medium transition-colors ${isFSApiSupported
